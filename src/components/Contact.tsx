...
export default function Contact({ active }: ContactProps) {
  ...
  return (
    <section id="contact" className="section-shell relative overflow-hidden bg-slate-950 py-12 text-white sm:py-16">
      ...
      >
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h2 className="text-3xl font-black leading-tight sm:max-w-[11ch] sm:text-4xl md:text-5xl">
              Let&apos;s build something impactful.
            </h2>

            <p className="mt-5 max-w-xl text-sm leading-7 text-slate-300 sm:text-lg sm:leading-8">
              Open to collaboration, information system development, application integration, and software engineering opportunities.
            </p>
          </div>

          <div
            className={`reveal-card rounded-[2rem] border border-white/10 bg-white/10 p-5 shadow-2xl backdrop-blur sm:p-8 ${
              visible ? "is-visible" : ""
            }`}
          ...
          >
            ...
            <div className="mt-6 space-y-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-start gap-2 rounded-2xl border border-white/10 bg-slate-900 px-5 py-4 text-white transition-all duration-300 hover:-translate-y-1 hover:border-blue-400 hover:bg-slate-800 sm:flex-row sm:items-center sm:justify-between"
              >
                <span className="font-bold">LinkedIn</span>
                <span className="text-sm text-slate-300 sm:shrink-0">View Profile -&gt;</span>
              </a>
              ...
              >
                ...
                <span className="text-sm text-slate-300 sm:shrink-0">View Repository -&gt;</span>
              </a>
            </div>
          </div>
        </div>
